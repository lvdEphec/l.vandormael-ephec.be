...
function remplirListeHabitats(reponse) {
    ...
    // Appelle le chargement des espèces pour l'habitat séectionné par défaut, le premier option du select.
	// Ci-dessous, le paramètre de "call" sert à appeler la fonction chargerEspeces
	// comme si le select d'id "choixHabitat" était l'appelant 
	// (et donc le "this" dans la fonction sera l'élément select, comme en cas d'événement change)
	chargerEspeces.call(document.getElementById("choixHabitat"));
}
